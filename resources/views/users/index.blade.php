  ...
  <table class="w-full table-auto">
      <thead class="bg-gray-50 text-xs font-semibold text-gray-400">
          <tr class="text-left">
              ...
              <th class="p-3 text-blue-900">email</th>
          ...
          @forelse ($users as $user)
              <tr class="hover:bg-gray-200">
                  ...
                  <td class="flex gap-5 p-3">
                      <a href="{{ route('users.edit', $user) }}"><i class="fa-solid fa-pencil"
                              style="color: #878787;"></i></a>
                      <form class="formDelete" action="{{ route('users.destroy', $user) }}" method="POST">
                          @csrf
                          @method('delete')
